...
public class ShopManager : MonoBehaviour
{
    ...
    private void Start()
    {
        shopSlots = new List<CardSO>(shopSize);
    ...
    public bool Purchase(int slotIndex)
    {
        ...
        if (!drawn)
        {
            ...
            card.Play(turnManager, resourceManager, handManager, this);
        }
        int newIndex = Random.Range(0, cardPool.Count);
        shopSlots[slotIndex] = cardPool[newIndex];
        RefreshShopUI();
        return true;
    }
